...
@extend_schema_view(
    list=extend_schema(
        tags=["아이돌 북마크 (Idol Bookmark)"], summary="내가 북마크한 아이돌 목록 조회"
    ),
    retrieve=extend_schema(
        tags=["아이돌 북마크 (Idol Bookmark)"], summary="북마크한 아이돌 상세 조회"
    ),
    create=extend_schema(
        tags=["아이돌 북마크 (Idol Bookmark)"], summary="아이돌 북마크 추가"
    ),
    destroy=extend_schema(
        tags=["아이돌 북마크 (Idol Bookmark)"], summary="아이돌 북마크 삭제"
    ),
)
...
@extend_schema_view(
    list=extend_schema(
        tags=["그룹 북마크 (Group Bookmark)"], summary="내가 북마크한 그룹 목록 조회"
    ),
    retrieve=extend_schema(
        tags=["그룹 북마크 (Group Bookmark)"], summary="북마크한 그룹 상세 조회"
    ),
    create=extend_schema(
        tags=["그룹 북마크 (Group Bookmark)"], summary="그룹 북마크 추가"
    ),
    destroy=extend_schema(
        tags=["그룹 북마크 (Group Bookmark)"], summary="그룹 북마크 삭제"
    ),
)
